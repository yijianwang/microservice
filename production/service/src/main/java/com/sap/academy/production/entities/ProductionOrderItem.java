...
public class ProductionOrderItem implements Serializable {
    ...
    public ProductionOrderItem(ProductionOrderItem productionOrderItem) {
        this.documentItemId = productionOrderItem.documentItemId;
        ...
        this.salesOrderNumber = productionOrderItem.salesOrderNumber;
    }
    ...
    public com.sap.academy.production.models.ProductionOrderItem toModelMapper() {
        ...
        item.setDocumentItemId(this.documentItemId);
        item.setMaterialNumber(this.materialNumber);
        item.setDescription(this.description);
        item.setQuantity(this.quantity);
        item.setUnitOfMeasure(this.unitOfMeasure);
        item.setSalesOrderNumber(this.salesOrderNumber);
        return item;
    }
